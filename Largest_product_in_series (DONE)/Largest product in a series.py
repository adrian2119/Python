# coding=utf-8
# coding=utf-8
# A four adjacent digits in the 1000-digit number that have the greatest product are 9 × 9 × 8 × 9 = 5832.
#
...
answer = 0
sortedAnswer = []
number = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9, 2, 2, 5, 1, 1, 9, 6, 7, 4, 4, 2, 6, 5, 7, 4, 7, 4,
...
while index < 1000 - 13:
    answer = number[index] * number[index + 1] * number[index + 2] * number[index + 3] * number[index + 4] * number[index + 5] * number[index + 6] * number[index + 7] * number[index + 8] * number[index + 9] * number[index + 10] * number[index + 11] * number[index + 12]
    index = index + 1
    print (answer)
    sortedAnswer.append(answer)
sortedAnswer.sort()
print (sortedAnswer)
